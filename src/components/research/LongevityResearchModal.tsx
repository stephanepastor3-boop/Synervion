...
import { LongevityAnimation } from './LongevityAnimation';

interface LongevityResearchModalProps {
    isOpen: boolean;
    onClose: () => void;
}

export function LongevityResearchModal({ isOpen, onClose }: LongevityResearchModalProps) {
    return (
        <AnimatePresence>
            {isOpen && (
                <motion.div
                ...
                >
                    ...
                    >
                        ...
                        <div style={{ textAlign: 'center', maxWidth: '800px', margin: '0 auto 40px' }}>
                            ...
                            >
                                Cordyceps militaris has historically been regarded as a rejuvenating agent,
                                neutralizing free radicals and protecting vital organs for long-term health.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-4">
                            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                                ...
                                <ul className="space-y-3">
                                    <li className="text-sm text-gray-600 leading-relaxed pl-4 relative">
                                        <span className="absolute left-0 top-1.5 w-1.5 h-1.5 rounded-full bg-orange-400"></span>
                                        Neutralizes harmful free radicals
                                    </li>
                                    <li className="text-sm text-gray-600 leading-relaxed pl-4 relative">
                                        <span className="absolute left-0 top-1.5 w-1.5 h-1.5 rounded-full bg-orange-400"></span>
                                        Cordycepin attenuates age-related oxidative stress
                                    </li>
                                    <li className="text-sm text-gray-600 leading-relaxed pl-4 relative">
                                        <span className="absolute left-0 top-1.5 w-1.5 h-1.5 rounded-full bg-orange-400"></span>
                                        High DPPH radical scavenging capacity
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                                ...
                                <ul className="space-y-3">
                                    ...
                                    <li className="text-sm text-gray-600 leading-relaxed pl-4 relative">
                                        <span className="absolute left-0 top-1.5 w-1.5 h-1.5 rounded-full bg-orange-400"></span>
                                        Reno-protective (Kidney) function support
                                    </li>
                                    <li className="text-sm text-gray-600 leading-relaxed pl-4 relative">
                                        <span className="absolute left-0 top-1.5 w-1.5 h-1.5 rounded-full bg-orange-400"></span>
                                        Pneumoprotective (Lung) benefits
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                                ...
                                <ul className="space-y-3">
                                    <li className="text-sm text-gray-600 leading-relaxed pl-4 relative">
                                        <span className="absolute left-0 top-1.5 w-1.5 h-1.5 rounded-full bg-orange-400"></span>
                                        Inhibits cell senescence (aging)
                                    </li>
                                    <li className="text-sm text-gray-600 leading-relaxed pl-4 relative">
                                        <span className="absolute left-0 top-1.5 w-1.5 h-1.5 rounded-full bg-orange-400"></span>
                        ...
                        <div style={{ textAlign: 'center', marginTop: '40px', padding: '24px', background: '#FFFFFF', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.04)' }}>
                            <p style={{ fontFamily: 'var(--synervion-font-body)', fontSize: '13px', color: '#8C8C8C', lineHeight: '1.6' }}>
                                Scientific references: Cordycepin extracts possess antioxidative properties and support metabolic organ function.
